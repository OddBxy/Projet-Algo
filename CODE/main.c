...
void gestionEvenement(EvenementGfx evenement)
{
	...
	switch (evenement)
	{
		case Initialisation:
			...
			imageFin = lisBMPRGB("ImageFin.bmp");
			image_acceuil = lisBMPRGB("Image_acceuil.bmp");
			image_jeu = lisBMPRGB("Image_jeu.bmp");
...
void afficheTps(int tpsJeu){
	...
	epaisseurDeTrait(8);
	afficheChaine(secs, 35, largeurFenetre()*0.5, hauteurFenetre()*0.2223);
